    ...
    datasets: [
      {
        ...
        backgroundColor: (context: any) => {
          const val = context.raw as number | undefined
          if (val === undefined) return 'rgba(0, 255, 136, 0.6)'
        ...
        borderColor: (context: any) => {
          const val = context.raw as number | undefined
          if (val === undefined) return '#00ff88'
  ...
  const options = {
    ...
    plugins: {
      ...
      tooltip: {
        ...
        displayColors: false,
        callbacks: {
          label: (context: any) => ` ${context.raw} ANOMALIES AT ${context.label}`
        }
      },
    },
    scales: {
